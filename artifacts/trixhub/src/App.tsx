...
import ActivitiesDiscoveryPage from "@/pages/activities-discovery";
import ActivitiesSurprisePage from "@/pages/activities-surprise";
  ...
  return (
    <>
      ...
      <Switch>
        ...
        <Route path="/activities/discovery" component={() => <ProtectedRoute component={ActivitiesDiscoveryPage} />} />
        <Route path="/activities/surprise" component={() => <ProtectedRoute component={ActivitiesSurprisePage} />} />
