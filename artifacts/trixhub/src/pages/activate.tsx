        ...
        {step === "info" && (
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4 lg:sticky lg:top-20 lg:self-start">
              ...
              <a
                href="/preuves"
                className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl border border-green-500/30 bg-green-500/5 text-green-700 dark:text-green-400 text-sm font-semibold hover:bg-green-500/10 transition-colors"
              >
