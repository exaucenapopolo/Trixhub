          ...
          return (
            <div className="bg-gradient-to-br from-amber-500/10 to-primary/5 border border-amber-500/25 rounded-2xl p-5 space-y-4">
              ...
              <div className="border-t border-amber-500/15 pt-3 space-y-2">
                <p className="text-[10px] text-muted-foreground font-semibold uppercase tracking-wider">Tu peux aussi activer ton compte maintenant</p>
                <div className="flex flex-col sm:flex-row gap-2">
                  <Link
                    href="/activate"
                    className="flex-1 inline-flex items-center justify-center gap-2 px-3 py-2.5 rounded-xl bg-primary text-primary-foreground text-xs font-bold hover:bg-primary/90 transition-colors"
                  >
                    <Zap className="w-3.5 h-3.5" /> Payer pour activer mon compte
                  </Link>
                  <Link
                    href="/depot"
                  ...
                  >
                    <PiggyBank className="w-3.5 h-3.5" /> Déposer de l'argent
                  </Link>
                </div>
                <p className="text-[10px] text-muted-foreground leading-snug">
                  En payant directement, toutes les futures commissions iront dans ton solde parrainage — et ta dette éventuelle sera annulée.
                </p>
              </div>
            </div>
          );
